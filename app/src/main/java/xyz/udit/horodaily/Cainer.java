 ...
 *
 */
public class Cainer extends Fragment {

    private static final String TAG = "Cainer";
    private static final String url = "http://www.cainer.com/today/piscest.html";
    TextView tv;
    ...
    class FetchData extends AsyncTask<Void, String, String> {
        ...
        private static final String TAG = "Cainer_FetchData";
