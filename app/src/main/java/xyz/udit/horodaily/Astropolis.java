 ...
 *
 */
public class Astropolis extends Fragment {

    private static final String TAG = "Astropolis";
    private static final String url = "http://www.astrolis.com/horoscopes/pisces";
    TextView tv;
    ...
    class FetchData extends AsyncTask<Void, String, String> {
        ...
        private static final String TAG = "Astropolis_FetchData";
        ...
        protected String doInBackground(Void... params) {
            try {
                ...
                Elements elements = document.select("span[itemprop='articleBody']");
